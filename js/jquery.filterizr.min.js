!(function (t) {
  ...
  function (t, e, r) {
    ...
    var i =
      ...
      y = { IDLE: "IDLE", FILTERING: "FILTERING", SORTING: "SORTING", SHUFFLING: "SHUFFLING" };
  },
  function (t, e, r) {
    "use strict";
    function i(t, e) {
      ...
      a = (function () {
        function t() {
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ".filtr-container",
            r = arguments[1];
          i(this, t), (this.$node = $(e)), (this.props = { FilterItems: this.getFilterItems(r), w: this.getWidth(), h: 0 }), this.$node.css({ padding: 0, position: "relative" });
        }
        return (
          s(t, [
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                t.destroy(),
                  ...
                  $(e + " *[data-filter]").off("click.Filterizr"),
                  $(e + " *[data-multifilter]").off("click.Filterizr"),
                  $(e + " *[data-shuffle]").off("click.Filterizr"),
                  $(e + " *[data-search]").off("keyup.Filterizr"),
                  $(e + " *[data-sortAsc]").off("click.Filterizr"),
                  $(e + " *[data-sortDesc]").off("click.Filterizr");
              },
            },
            {
              key: "insertItem",
            ...
            },
            {
              ...
              value: function (t) {
                Object(l.c)("animationDuration", t.animationDuration, "number"),
                  ...
                  Object(l.c)("easing", t.easing, "string", l.e, "https://www.w3schools.com/cssref/css3_pr_transition-timing-function.asp"),
          ...
          o(t, [
            ...
            },
            {
              ...
              value: function () {
                ...
                $(t + "[data-filter]").off("click.Filterizr"),
                  $(t + "[data-multifilter]").off("click.Filterizr"),
                  $(t + "[data-shuffle]").off("click.Filterizr"),
                  $(t + "[data-search]").off("keyup.Filterizr"),
                  $(t + "[data-sortAsc]").off("click.Filterizr"),
                  $(t + "[data-sortDesc]").off("click.Filterizr");
              },
            },
          ]),
          t
    ...
    var i = function (t) {
        var e = t.props,
          ...
          u = i.map(function (t, e) {
            var r = t.props.h;
            return r > a && (a = r), e % o == 0 && e >= o && (s++, (l += a), (a = 0)), { left: (e - o * s) * t.props.w, top: n(i, o, e) };
          });
  ...
  function (t, e, r) {
    ...
    (n.prototype = {
      ...
      growDown: function (t, e) {
        var r;
        return (this.root = { used: !0, x: 0, y: 0, w: this.root.w, h: this.root.h + e, down: { x: 0, y: this.root.h, w: this.root.w, h: e }, right: this.root }), (r = this.findNode(this.root, t, e)) ? this.splitNode(r, t, e) : null;
      },
    }),
      (e.a = i);
  },
