          ...
          var e = "tooltip",
            ...
            I = (function () {
              ...
              return (
                ...
                (h.prototype.show = function () {
                  ...
                  if (this.isWithContent() && this._isEnabled) {
                    ...
                    t(o).data(this.constructor.DATA_KEY, this).appendTo(c),
                      ...
                      (this._tether = new Tether({ attachment: l, element: o, target: this.element, classes: v, classPrefix: u, offset: this.config.offset, constraints: this.config.constraints, addTargetClasses: !1 })),
                      r.reflow(o),
                ...
                (h.prototype._getConfig = function (n) {
                  return (
                    (n = t.extend({}, this.constructor.Default, t(this.element).data(), n)), n.delay && "number" == typeof n.delay && (n.delay = { show: n.delay, hide: n.delay }), r.typeCheckConfig(e, n, this.constructor.DefaultType), n
                  );
                }),
