(function (global, factory) {
  ...
  function getOffsetRect(a) {
    ...
    return (
      (c =
        a === b
          ? { width: Math.max(b.clientWidth, window.innerWidth || 0), height: Math.max(b.clientHeight, window.innerHeight || 0), left: 0, top: 0 }
  ...
  function getBoundaries(a, b, c) {
    ...
    if ("window" === c) {
      ...
      d =
        "fixed" === _h
          ? { top: 0, right: window.document.documentElement.clientWidth, bottom: window.document.documentElement.clientHeight, left: 0 }
          : { top: 0 - _g.top, right: window.document.documentElement.clientWidth - _g.left, bottom: window.document.documentElement.clientHeight - _g.top, left: 0 - _g.left };
  ...
  function applyStyle(a) {
    ...
    return (
      a.instance.options.gpuAcceleration && e ? ((b[e] = "translate3d(" + c + "px, " + d + "px, 0)"), (b.top = 0), (b.left = 0)) : ((b.left = c), (b.top = d)),
    ...
    return (
      ...
      g.forEach(function (h, i) {
        ...
        (k || m) &&
          ...
          (a.placement = d + (f ? "-" + f : "")),
          (a.offsets.popper = getOffsets(a.instance.state, a.instance.popper, a.instance.reference, a.placement).popper),
  ...
  function keepTogether(a) {
    ...
    return (
      -1 === ["top", "bottom"].indexOf(e)
        ? (b.bottom < d(c.top) && (a.offsets.popper.top = d(c.top) - b.height), b.top > d(c.bottom) && (a.offsets.popper.top = d(c.bottom)))
        : (b.right < d(c.left) && (a.offsets.popper.left = d(c.left) - b.width), b.left > d(c.right) && (a.offsets.popper.left = d(c.right))),
      a
    );
  }
  ...
  var DEFAULTS = {
    ...
    modifiers: {
      ...
      preventOverflow: { order: 300, enabled: !0, function: modifiersFunctions.preventOverflow, priority: ["left", "right", "top", "bottom"], padding: 5, boundariesElement: "scrollParent" },
      ...
      flip: { order: 600, enabled: !0, function: modifiersFunctions.flip, behavior: "flip", padding: 5, boundariesElement: "viewport" },
      hide: { order: 700, enabled: !0, function: modifiersFunctions.hide },
      applyStyle: { order: 800, enabled: !0, function: modifiersFunctions.applyStyle, onLoad: modifiersOnLoad.applyStyleOnLoad },
    },
  };
  var Popper = (function () {
    function Popper(a, b) {
          ...
          value: function update() {
            ...
            (this.state.position = getPosition(this.reference)),
              ...
              this.state.isDestroyed ||
                ...
                this.state.isCreated ? isFunction(this.state.updateCallback) && this.state.updateCallback(a) : ((this.state.isCreated = !0), isFunction(this.state.createCallback) && this.state.createCallback(a)));
          },
        },
        {
          key: "onCreate",
